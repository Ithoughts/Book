...
// Books is a subclass of UIView and conforms to the informal protocol --- UIGLViewProtocol
@interface BooksEAGLView : UIView <UIGLViewProtocol, BooksManagerDelegateProtocol, ImagesManagerDelegateProtocol, SampleGLResourceHandler>
{
...
@private
    ...
    // Lock to prevent concurrent access of the framebuffer on the main and render threads (layoutSubViews and renderFrameQCAR methods)
