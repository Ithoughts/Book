...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        QCAR::setInitParameters(mQCARInitFlags,"52d728f626f348668b37b7b7f9f6756f");
...
- (void) changeOrientation:(UIInterfaceOrientation) ARViewOrientation {
    ...
    [self configureVideoBackgroundWithViewWidth:arViewBoundsSize.width andHeight:arViewBoundsSize.height];
